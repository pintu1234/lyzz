...
= 4.8 =
* 2018-03-25 Dave Ross <dave@davidmichaelross.com>
* Fixed an old-school PHP 4 style constructor still hanging around
* Made DWLS_Util::match_array_key_or_default() static
* Fix bug that sent people to a 404 when clicking outside the title on inner pages
* Accessiblity improvement (hides the search results from screen readers)

= 4.7 =
* 2018-03-25 Dave Ross <dave@davidmichaelross.com>
* Fix for "dwls_alter_results" filter -- thanks Alex Chisholm!
