...
Plugin URI: 
Description: Add thumbs up/down rating to your content. <strong>Modified version by <a href="http://themeforest.net/user/An-Themes/portfolio">AnThemes</a>, don't update.</strong>
Author: 
Version: 10.0
Author URI: 
*/
...
if  ( ! function_exists( 'thumbs_rating_getlink' ) ):
	...
	function thumbs_rating_getlink($post_ID = '', $type_of_vote = '')
	{
		...
		$link_up = '<span class="thumbs-rating-up'. ( (isset($thumbs_rating_up_count) && intval($thumbs_rating_up_count) > 0 ) ? ' thumbs-rating-voted' : '' ) .'" onclick="thumbs_rating_vote(' . $post_ID . ', 1);"><i class="fa fa-thumbs-o-up"></i> ' . $thumbs_rating_up_count . '</span>';
		$link_down = '<span class="thumbs-rating-down'. ( (isset($thumbs_rating_down_count) && intval($thumbs_rating_down_count) > 0 ) ? ' thumbs-rating-voted' : '' ) .'" onclick="thumbs_rating_vote(' . $post_ID . ', 2);"><i class="fa fa-thumbs-o-down"></i> ' . $thumbs_rating_down_count . '</span>';
