...
class anthemes_recentreviews extends WP_Widget {
    function __construct() {
      $widget_ops = array('description' => __('Your site\'s Recent Reviews.', 'anthemes'));
      parent::__construct(false, $name = ''. __('Custom: Recent Reviews', 'anthemes') .'',$widget_ops); 
    }
...
// register widget
function anthemes_recentreviews_init_widget () {
    return register_widget('anthemes_recentreviews');
  }
add_action ('widgets_init', 'anthemes_recentreviews_init_widget');
?>