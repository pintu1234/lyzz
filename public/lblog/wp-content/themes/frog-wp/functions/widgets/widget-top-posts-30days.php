<?php
// ------------------------------------------------------
// ------ Top Articles in last 30 days  -----------------
// ------ by AnThemes.net -------------------------------
//        http://themeforest.net/user/An-Themes/portfolio
//        http://themeforest.net/user/An-Themes/follow 
// ------------------------------------------------------

class anthemes_toparticles extends WP_Widget {
     function __construct() {
      $widget_ops = array('description' => __('Top posts in last 30 days by comments.', 'anthemes'));
      parent::__construct(false, $name = ''. __('Custom: Top Articles in last 30 days', 'anthemes') .'',$widget_ops); 
    }
...
<ul class="article_list">
                ...
                query_posts('post_type=post&posts_per_page='. esc_attr($number) .'&orderby=comment_count&order=DESC');
                $c=0; while (have_posts()): the_post(); ?>
...
// register widget
function anthemes_toparticles_init_widget () {
    return register_widget('anthemes_toparticles');
  }
add_action ('widgets_init', 'anthemes_toparticles_init_widget');
?>