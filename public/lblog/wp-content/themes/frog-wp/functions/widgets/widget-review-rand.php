...
class anthemes_randreviews extends WP_Widget {
    function __construct() {
      $widget_ops = array('description' => __('Your site\'s Random Reviews.', 'anthemes'));
      parent::__construct(false, $name = ''. __('Custom: Random Reviews', 'anthemes') .'',$widget_ops); 
    }
...
// register widget
function anthemes_randreviews_init_widget () {
    return register_widget('anthemes_randreviews');
  }
add_action ('widgets_init', 'anthemes_randreviews_init_widget');
?>