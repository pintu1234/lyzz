...
class anthemes_recentposts extends WP_Widget {
     function __construct() {
      $widget_ops = array('description' => __('Your site\'s most recent Posts.', 'anthemes'));
        parent::__construct(false, $name = ''. __('Custom: Recent Posts', 'anthemes') .'',$widget_ops); 
    }
...
// register widget
function anthemes_recentposts_init_widget () {
    return register_widget('anthemes_recentposts');
  }
add_action ('widgets_init', 'anthemes_recentposts_init_widget');
?>