	...
	class Blog_Way_About {
		...
		public function load_assets( $hook ) {
			...
			if ( 'appearance_page_' . $this->page_slug === $hook ) {
				...
				wp_enqueue_style( 'blog-way-about', get_template_directory_uri() . '/inc/theme-info/css/about.css', array(), '3.1.6' );
				wp_enqueue_script( 'blog-way-about', get_template_directory_uri() . '/inc/theme-info/js/about.js', array( 'jquery' ), '3.1.6' );
				$js_vars = array(
