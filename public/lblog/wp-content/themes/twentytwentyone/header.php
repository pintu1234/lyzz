...
<head>
    ...
    <!--<link type="text/css" href="http://127.0.0.1:8000/css/style.css" rel="stylesheet" />-->
    <style>
...
.scrollbar1{height: 253px;}
    ...
    <link type="text/css" href="http://127.0.0.1:8000/css/blog.css" rel="stylesheet">
</head>
...
<header>
	...
	<div class="head-nav head-navigation">
            <ul>
                ...
                <li><a  class="active"  href="http://127.0.0.1:8000/blogs">Blog</a></li>
...
<nav class="navigation" id="navigation">
    <a class="nav-close anim" onclick="closeNav()"><img src="http://127.0.0.1:8000/images/nav-close.svg" /></a>
    <div class="scrollbar scrollbar2">

	<ul>
        <li ><a href="http://127.0.0.1:8000">Home</a></li>
        <li  class="active" ><a href="http://127.0.0.1:8000/blogs">Blog</a></li>
        <li ><a href="http://127.0.0.1:8000/contact-us">Contact</a></li>
        <li  style="border-bottom: 1px solid;"><a href="https://lyzz.hcbspro.com/login">Login</a></li>
	</ul>
	<ul class="submenu">
